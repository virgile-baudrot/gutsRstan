...
# TK-TD fitting with GUTS-SD, GUTS-IT, GUTS-PROPER _lN and GUTS-PROPER _ll
...
Both model `IT` and `PROPER` support the `_lN` and `loglgistic` distribution which has to be
specified with the argument `distribution`. The default is `_ll`.
