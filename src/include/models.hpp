...
namespace model_ode_TKTD_varCOMBINED_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_ode_TKTD_varCOMBINED");
    reader.add_event(280, 280, "end", "model_ode_TKTD_varCOMBINED");
    return reader;
}
...
solve_TKTD_varSD(const std::vector<T0__>& y0,
                     ...
                     const std::vector<T5__>& conc, std::ostream* pstream__) {
    ...
    try {
        ...
        return stan::math::promote_scalar<fun_return_scalar_t__>(to_matrix(integrate_ode_rk45(TKTD_varSD_functor__(), y0, t0, ts, theta, to_array_1d(append_row(to_vector(tconc),to_vector(conc))), x_i, pstream__, 1.0000000000000001e-09, 9.9999999999999995e-08, 1000.0)));
        }
    } catch (const std::exception& e) {
        stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
        // Next line prevents compiler griping about no return
...
struct solve_TKTD_varSD_functor__ {
    ...
    operator()(const std::vector<T0__>& y0,
                     ...
                     const std::vector<T3__>& theta,
                     const std::vector<T4__>& tconc,
                     const std::vector<T5__>& conc, std::ostream* pstream__) const {
        return solve_TKTD_varSD(y0, t0, ts, theta, tconc, conc, pstream__);
    }
};

class model_ode_TKTD_varCOMBINED : public prob_grad {
private:
    int n_group;
    int n_data_conc;
    vector<double> conc;
    ...
    vector<int> Nsurv_IT;
public:
    model_ode_TKTD_varCOMBINED(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_ode_TKTD_varCOMBINED_namespace::model_ode_TKTD_varCOMBINED";
        ...
        try {
            ...
            validate_non_negative_index("Nsurv_SD", "n_data_Nsurv", n_data_Nsurv);
            Nsurv_SD = std::vector<int>(n_data_Nsurv,int(0));
            stan::math::fill(Nsurv_SD, std::numeric_limits<int>::min());
            validate_non_negative_index("Nsurv_IT", "n_data_Nsurv", n_data_Nsurv);
            Nsurv_IT = std::vector<int>(n_data_Nsurv,int(0));
            stan::math::fill(Nsurv_IT, std::numeric_limits<int>::min());

            stan::math::assign(Nsurv_SD, Nsurv);
            stan::math::assign(Nsurv_IT, Nsurv);
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        if (!(context__.contains_r("kk_log10")))
            throw std::runtime_error("variable kk_log10 missing");
        vals_r__ = context__.vals_r("kk_log10");
        pos__ = 0U;
        context__.validate_dims("initialization", "kk_log10", "double", context__.to_vec());
        double kk_log10(0);
        kk_log10 = vals_r__[pos__++];
        try {
            writer__.scalar_unconstrain(kk_log10);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable kk_log10: ") + e.what());
        }

        if (!(context__.contains_r("z_log10")))
            throw std::runtime_error("variable z_log10 missing");
        vals_r__ = context__.vals_r("z_log10");
        pos__ = 0U;
        context__.validate_dims("initialization", "z_log10", "double", context__.to_vec());
        double z_log10(0);
        z_log10 = vals_r__[pos__++];
        try {
            writer__.scalar_unconstrain(z_log10);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable z_log10: ") + e.what());
        }

        if (!(context__.contains_r("kd_log10")))
            throw std::runtime_error("variable kd_log10 missing");
        vals_r__ = context__.vals_r("kd_log10");
        pos__ = 0U;
        context__.validate_dims("initialization", "kd_log10", "double", context__.to_vec());
        double kd_log10(0);
        kd_log10 = vals_r__[pos__++];
        try {
            writer__.scalar_unconstrain(kd_log10);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable kd_log10: ") + e.what());
        }

        if (!(context__.contains_r("hb_log10")))
            throw std::runtime_error("variable hb_log10 missing");
        vals_r__ = context__.vals_r("hb_log10");
        pos__ = 0U;
        context__.validate_dims("initialization", "hb_log10", "double", context__.to_vec());
        double hb_log10(0);
        hb_log10 = vals_r__[pos__++];
        try {
            writer__.scalar_unconstrain(hb_log10);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable hb_log10: ") + e.what());
        }

        if (!(context__.contains_r("alpha_log10")))
            throw std::runtime_error("variable alpha_log10 missing");
        vals_r__ = context__.vals_r("alpha_log10");
        pos__ = 0U;
        context__.validate_dims("initialization", "alpha_log10", "double", context__.to_vec());
        double alpha_log10(0);
        alpha_log10 = vals_r__[pos__++];
        try {
            writer__.scalar_unconstrain(alpha_log10);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable alpha_log10: ") + e.what());
        }
        ...
        for (int i0__ = 0U; i0__ < 2; ++i0__)
            try {
            writer__.scalar_lb_unconstrain(0,y0[i0__]);
        } catch (const std::exception& e) { 
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                kk_log10 = in__.scalar_constrain(lp__);
            else
                kk_log10 = in__.scalar_constrain();

            T__ z_log10;
            (void) z_log10;  // dummy to suppress unused var warning
            if (jacobian__)
                z_log10 = in__.scalar_constrain(lp__);
            else
                z_log10 = in__.scalar_constrain();

            T__ kd_log10;
            (void) kd_log10;  // dummy to suppress unused var warning
            if (jacobian__)
                kd_log10 = in__.scalar_constrain(lp__);
            else
                kd_log10 = in__.scalar_constrain();

            T__ hb_log10;
            (void) hb_log10;  // dummy to suppress unused var warning
            if (jacobian__)
                hb_log10 = in__.scalar_constrain(lp__);
            else
                hb_log10 = in__.scalar_constrain();

            T__ alpha_log10;
            (void) alpha_log10;  // dummy to suppress unused var warning
            if (jacobian__)
                alpha_log10 = in__.scalar_constrain(lp__);
            else
                alpha_log10 = in__.scalar_constrain();
            ...
            for (size_t k_0__ = 0; k_0__ < dim_y0_0__; ++k_0__) {
                if (jacobian__)
                    y0.push_back(in__.scalar_lb_constrain(0,lp__));
                else
                    y0.push_back(in__.scalar_lb_constrain(0));
            }
            ...
            validate_non_negative_index("Psurv_SD_hat", "n_data_Nsurv", n_data_Nsurv);
            Eigen::Matrix<T__,Eigen::Dynamic,1>  Psurv_SD_hat(static_cast<Eigen::VectorXd::Index>(n_data_Nsurv));
            (void) Psurv_SD_hat;  // dummy to suppress unused var warning

            stan::math::initialize(Psurv_SD_hat, DUMMY_VAR__);
            stan::math::fill(Psurv_SD_hat,DUMMY_VAR__);
            validate_non_negative_index("Psurv_IT_hat", "n_data_Nsurv", n_data_Nsurv);
            Eigen::Matrix<T__,Eigen::Dynamic,1>  Psurv_IT_hat(static_cast<Eigen::VectorXd::Index>(n_data_Nsurv));
            (void) Psurv_IT_hat;  // dummy to suppress unused var warning

            stan::math::initialize(Psurv_IT_hat, DUMMY_VAR__);
            stan::math::fill(Psurv_IT_hat,DUMMY_VAR__);
            validate_non_negative_index("Conditional_Psurv_SD_hat", "n_data_Nsurv", n_data_Nsurv);
            Eigen::Matrix<T__,Eigen::Dynamic,1>  Conditional_Psurv_SD_hat(static_cast<Eigen::VectorXd::Index>(n_data_Nsurv));
            (void) Conditional_Psurv_SD_hat;  // dummy to suppress unused var warning

            stan::math::initialize(Conditional_Psurv_SD_hat, DUMMY_VAR__);
            stan::math::fill(Conditional_Psurv_SD_hat,DUMMY_VAR__);
            validate_non_negative_index("Conditional_Psurv_IT_hat", "n_data_Nsurv", n_data_Nsurv);
            Eigen::Matrix<T__,Eigen::Dynamic,1>  Conditional_Psurv_IT_hat(static_cast<Eigen::VectorXd::Index>(n_data_Nsurv));
            (void) Conditional_Psurv_IT_hat;  // dummy to suppress unused var warning

            stan::math::initialize(Conditional_Psurv_IT_hat, DUMMY_VAR__);
            stan::math::fill(Conditional_Psurv_IT_hat,DUMMY_VAR__);
            ...
            for (int gr = 1; gr <= n_group; ++gr) {
                ...
                stan::model::assign(y_hat, 
                            ...
                            solve_TKTD_varSD(y0,-(1.0000000000000001e-09),stan::model::rvalue(tNsurv, stan::model::cons_list(stan::model::index_min_max(get_base1(idS_lw,gr,"idS_lw",1), get_base1(idS_up,gr,"idS_up",1)), stan::model::nil_index_list()), "tNsurv"),param,stan::model::rvalue(tconc, stan::model::cons_list(stan::model::index_min_max(get_base1(idC_lw,gr,"idC_lw",1), get_base1(idC_up,gr,"idC_up",1)), stan::model::nil_index_list()), "tconc"),stan::model::rvalue(conc, stan::model::cons_list(stan::model::index_min_max(get_base1(idC_lw,gr,"idC_lw",1), get_base1(idC_up,gr,"idC_up",1)), stan::model::nil_index_list()), "conc"), pstream__), 
                            "assigning variable y_hat");
                stan::model::assign(Psurv_SD_hat, 
                            ...
                            "assigning variable Psurv_SD_hat");
                for (int i = get_base1(idS_lw,gr,"idS_lw",1); i <= get_base1(idS_up,gr,"idS_up",1); ++i) {

                    stan::math::assign(get_base1_lhs(Psurv_IT_hat,i,"Psurv_IT_hat",1), (exp((-(get_base1(param,1,"param",1)) * get_base1(tNsurv,i,"tNsurv",1))) * (1 - exp(-(log1p_exp((-(beta) * (log(max(stan::model::rvalue(y_hat, stan::model::cons_list(stan::model::index_min_max(get_base1(idS_lw,gr,"idS_lw",1), i), stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list())), "y_hat"))) - log(alpha)))))))));
                    stan::math::assign(get_base1_lhs(Conditional_Psurv_SD_hat,i,"Conditional_Psurv_SD_hat",1), (logical_eq(i,get_base1(idS_lw,gr,"idS_lw",1)) ? stan::math::promote_scalar<T__>(get_base1(Psurv_SD_hat,i,"Psurv_SD_hat",1)) : stan::math::promote_scalar<T__>((get_base1(Psurv_SD_hat,i,"Psurv_SD_hat",1) / get_base1(Psurv_SD_hat,(i - 1),"Psurv_SD_hat",1))) ));
                    stan::math::assign(get_base1_lhs(Conditional_Psurv_IT_hat,i,"Conditional_Psurv_IT_hat",1), (logical_eq(i,get_base1(idS_lw,gr,"idS_lw",1)) ? stan::math::promote_scalar<T__>(get_base1(Psurv_IT_hat,i,"Psurv_IT_hat",1)) : stan::math::promote_scalar<T__>((get_base1(Psurv_IT_hat,i,"Psurv_IT_hat",1) / get_base1(Psurv_IT_hat,(i - 1),"Psurv_IT_hat",1))) ));
                }
            }
            ...
            for (int i0__ = 0; i0__ < n_data_Nsurv; ++i0__) {
                if (stan::math::is_uninitialized(Psurv_SD_hat(i0__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: Psurv_SD_hat" << '[' << i0__ << ']';
                    throw std::runtime_error(msg__.str());
                }
            }
            for (int i0__ = 0; i0__ < n_data_Nsurv; ++i0__) {
                if (stan::math::is_uninitialized(Psurv_IT_hat(i0__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: Psurv_IT_hat" << '[' << i0__ << ']';
                    throw std::runtime_error(msg__.str());
                }
            }
            for (int i0__ = 0; i0__ < n_data_Nsurv; ++i0__) {
                if (stan::math::is_uninitialized(Conditional_Psurv_SD_hat(i0__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: Conditional_Psurv_SD_hat" << '[' << i0__ << ']';
                    throw std::runtime_error(msg__.str());
                }
            }
            for (int i0__ = 0; i0__ < n_data_Nsurv; ++i0__) {
                if (stan::math::is_uninitialized(Conditional_Psurv_IT_hat(i0__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: Conditional_Psurv_IT_hat" << '[' << i0__ << ']';
                    throw std::runtime_error(msg__.str());
                }
            }
            ...
            check_greater_or_equal(function__,"Psurv_SD_hat",Psurv_SD_hat,0);
            check_less_or_equal(function__,"Psurv_SD_hat",Psurv_SD_hat,1);
            check_greater_or_equal(function__,"Psurv_IT_hat",Psurv_IT_hat,0);
            check_less_or_equal(function__,"Psurv_IT_hat",Psurv_IT_hat,1);
            check_greater_or_equal(function__,"Conditional_Psurv_SD_hat",Conditional_Psurv_SD_hat,0);
            check_less_or_equal(function__,"Conditional_Psurv_SD_hat",Conditional_Psurv_SD_hat,1);
            check_greater_or_equal(function__,"Conditional_Psurv_IT_hat",Conditional_Psurv_IT_hat,0);
            check_less_or_equal(function__,"Conditional_Psurv_IT_hat",Conditional_Psurv_IT_hat,1);

            // model body

            lp_accum__.add(normal_log<propto__>(kd_log10, kd_meanlog10, kd_sdlog10));
            lp_accum__.add(normal_log<propto__>(hb_log10, hb_meanlog10, hb_sdlog10));
            lp_accum__.add(normal_log<propto__>(kk_log10, kk_meanlog10, kk_sdlog10));
            lp_accum__.add(normal_log<propto__>(z_log10, alpha_meanlog10, alpha_sdlog10));
            lp_accum__.add(normal_log<propto__>(alpha_log10, alpha_meanlog10, alpha_sdlog10));
            lp_accum__.add(uniform_log<propto__>(beta_log10, beta_minlog10, beta_maxlog10));
            lp_accum__.add(exponential_log<propto__>(y0, 1000000000.0));
            for (int gr = 1; gr <= n_group; ++gr) {

                lp_accum__.add(binomial_log<propto__>(stan::model::rvalue(Nsurv_SD, stan::model::cons_list(stan::model::index_min_max(get_base1(idS_lw,gr,"idS_lw",1), get_base1(idS_up,gr,"idS_up",1)), stan::model::nil_index_list()), "Nsurv_SD"), stan::model::rvalue(Nprec, stan::model::cons_list(stan::model::index_min_max(get_base1(idS_lw,gr,"idS_lw",1), get_base1(idS_up,gr,"idS_up",1)), stan::model::nil_index_list()), "Nprec"), stan::model::rvalue(Conditional_Psurv_SD_hat, stan::model::cons_list(stan::model::index_min_max(get_base1(idS_lw,gr,"idS_lw",1), get_base1(idS_up,gr,"idS_up",1)), stan::model::nil_index_list()), "Conditional_Psurv_SD_hat")));
                lp_accum__.add(binomial_log<propto__>(stan::model::rvalue(Nsurv_IT, stan::model::cons_list(stan::model::index_min_max(get_base1(idS_lw,gr,"idS_lw",1), get_base1(idS_up,gr,"idS_up",1)), stan::model::nil_index_list()), "Nsurv_IT"), stan::model::rvalue(Nprec, stan::model::cons_list(stan::model::index_min_max(get_base1(idS_lw,gr,"idS_lw",1), get_base1(idS_up,gr,"idS_up",1)), stan::model::nil_index_list()), "Nprec"), stan::model::rvalue(Conditional_Psurv_IT_hat, stan::model::cons_list(stan::model::index_min_max(get_base1(idS_lw,gr,"idS_lw",1), get_base1(idS_up,gr,"idS_up",1)), stan::model::nil_index_list()), "Conditional_Psurv_IT_hat")));
            }
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("Psurv_SD_hat");
        names__.push_back("Psurv_IT_hat");
        names__.push_back("Conditional_Psurv_SD_hat");
        names__.push_back("Conditional_Psurv_IT_hat");
        names__.push_back("Nsurv_SD_ppc");
        names__.push_back("Nsurv_SD_sim");
        names__.push_back("Nsurv_SD_sim_prec");
        names__.push_back("Nsurv_IT_ppc");
        names__.push_back("Nsurv_IT_sim");
        names__.push_back("Nsurv_IT_sim_prec");
    }
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "model_ode_TKTD_varCOMBINED_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        double kk_log10 = in__.scalar_constrain();
        double z_log10 = in__.scalar_constrain();
        double kd_log10 = in__.scalar_constrain();
        double hb_log10 = in__.scalar_constrain();
        double alpha_log10 = in__.scalar_constrain();
        ...
        try {
            ...
            stan::math::fill(y_hat,DUMMY_VAR__);
            validate_non_negative_index("Psurv_SD_hat", "n_data_Nsurv", n_data_Nsurv);
            vector_d Psurv_SD_hat(static_cast<Eigen::VectorXd::Index>(n_data_Nsurv));
            (void) Psurv_SD_hat;  // dummy to suppress unused var warning

            stan::math::initialize(Psurv_SD_hat, std::numeric_limits<double>::quiet_NaN());
            stan::math::fill(Psurv_SD_hat,DUMMY_VAR__);
            validate_non_negative_index("Psurv_IT_hat", "n_data_Nsurv", n_data_Nsurv);
            vector_d Psurv_IT_hat(static_cast<Eigen::VectorXd::Index>(n_data_Nsurv));
            (void) Psurv_IT_hat;  // dummy to suppress unused var warning

            stan::math::initialize(Psurv_IT_hat, std::numeric_limits<double>::quiet_NaN());
            stan::math::fill(Psurv_IT_hat,DUMMY_VAR__);
            validate_non_negative_index("Conditional_Psurv_SD_hat", "n_data_Nsurv", n_data_Nsurv);
            vector_d Conditional_Psurv_SD_hat(static_cast<Eigen::VectorXd::Index>(n_data_Nsurv));
            (void) Conditional_Psurv_SD_hat;  // dummy to suppress unused var warning

            stan::math::initialize(Conditional_Psurv_SD_hat, std::numeric_limits<double>::quiet_NaN());
            stan::math::fill(Conditional_Psurv_SD_hat,DUMMY_VAR__);
            validate_non_negative_index("Conditional_Psurv_IT_hat", "n_data_Nsurv", n_data_Nsurv);
            vector_d Conditional_Psurv_IT_hat(static_cast<Eigen::VectorXd::Index>(n_data_Nsurv));
            (void) Conditional_Psurv_IT_hat;  // dummy to suppress unused var warning

            stan::math::initialize(Conditional_Psurv_IT_hat, std::numeric_limits<double>::quiet_NaN());
            stan::math::fill(Conditional_Psurv_IT_hat,DUMMY_VAR__);
            ...
            for (int gr = 1; gr <= n_group; ++gr) {
                ...
                for (int i = get_base1(idS_lw,gr,"idS_lw",1); i <= get_base1(idS_up,gr,"idS_up",1); ++i) {
                    ...
                    stan::math::assign(get_base1_lhs(Psurv_IT_hat,i,"Psurv_IT_hat",1), (exp((-(get_base1(param,1,"param",1)) * get_base1(tNsurv,i,"tNsurv",1))) * (1 - exp(-(log1p_exp((-(beta) * (log(max(stan::model::rvalue(y_hat, stan::model::cons_list(stan::model::index_min_max(get_base1(idS_lw,gr,"idS_lw",1), i), stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list())), "y_hat"))) - log(alpha)))))))));
                    stan::math::assign(get_base1_lhs(Conditional_Psurv_SD_hat,i,"Conditional_Psurv_SD_hat",1), (logical_eq(i,get_base1(idS_lw,gr,"idS_lw",1)) ? stan::math::promote_scalar<double>(get_base1(Psurv_SD_hat,i,"Psurv_SD_hat",1)) : stan::math::promote_scalar<double>((get_base1(Psurv_SD_hat,i,"Psurv_SD_hat",1) / get_base1(Psurv_SD_hat,(i - 1),"Psurv_SD_hat",1))) ));
                    stan::math::assign(get_base1_lhs(Conditional_Psurv_IT_hat,i,"Conditional_Psurv_IT_hat",1), (logical_eq(i,get_base1(idS_lw,gr,"idS_lw",1)) ? stan::math::promote_scalar<double>(get_base1(Psurv_IT_hat,i,"Psurv_IT_hat",1)) : stan::math::promote_scalar<double>((get_base1(Psurv_IT_hat,i,"Psurv_IT_hat",1) / get_base1(Psurv_IT_hat,(i - 1),"Psurv_IT_hat",1))) ));
                }
            }
        ...
        vars__.push_back(beta);
            ...
            for (int k_0__ = 0; k_0__ < n_data_Nsurv; ++k_0__) {
            vars__.push_back(Psurv_SD_hat[k_0__]);
            }
            for (int k_0__ = 0; k_0__ < n_data_Nsurv; ++k_0__) {
            vars__.push_back(Psurv_IT_hat[k_0__]);
            }
            for (int k_0__ = 0; k_0__ < n_data_Nsurv; ++k_0__) {
            vars__.push_back(Conditional_Psurv_SD_hat[k_0__]);
            }
            for (int k_0__ = 0; k_0__ < n_data_Nsurv; ++k_0__) {
            vars__.push_back(Conditional_Psurv_IT_hat[k_0__]);
            }

            if (!include_gqs__) return;
            // declare and define generated quantities
            validate_non_negative_index("Nsurv_SD_ppc", "n_data_Nsurv", n_data_Nsurv);
            vector<int> Nsurv_SD_ppc(n_data_Nsurv, 0);
            stan::math::fill(Nsurv_SD_ppc, std::numeric_limits<int>::min());
            validate_non_negative_index("Nsurv_SD_sim", "n_data_Nsurv", n_data_Nsurv);
            vector<int> Nsurv_SD_sim(n_data_Nsurv, 0);
            stan::math::fill(Nsurv_SD_sim, std::numeric_limits<int>::min());
            validate_non_negative_index("Nsurv_SD_sim_prec", "n_data_Nsurv", n_data_Nsurv);
            vector<int> Nsurv_SD_sim_prec(n_data_Nsurv, 0);
            stan::math::fill(Nsurv_SD_sim_prec, std::numeric_limits<int>::min());
            validate_non_negative_index("Nsurv_IT_ppc", "n_data_Nsurv", n_data_Nsurv);
            vector<int> Nsurv_IT_ppc(n_data_Nsurv, 0);
            stan::math::fill(Nsurv_IT_ppc, std::numeric_limits<int>::min());
            validate_non_negative_index("Nsurv_IT_sim", "n_data_Nsurv", n_data_Nsurv);
            vector<int> Nsurv_IT_sim(n_data_Nsurv, 0);
            stan::math::fill(Nsurv_IT_sim, std::numeric_limits<int>::min());
            validate_non_negative_index("Nsurv_IT_sim_prec", "n_data_Nsurv", n_data_Nsurv);
            vector<int> Nsurv_IT_sim_prec(n_data_Nsurv, 0);
            stan::math::fill(Nsurv_IT_sim_prec, std::numeric_limits<int>::min());
            ...
            for (int gr = 1; gr <= n_group; ++gr) {
                ...
                for (int i = get_base1(idS_lw,gr,"idS_lw",1); i <= get_base1(idS_up,gr,"idS_up",1); ++i) {
                    ...
                    stan::math::assign(get_base1_lhs(Nsurv_SD_ppc,i,"Nsurv_SD_ppc",1), binomial_rng(get_base1(Nprec,i,"Nprec",1),get_base1(Conditional_Psurv_SD_hat,i,"Conditional_Psurv_SD_hat",1), base_rng__));
                    stan::math::assign(get_base1_lhs(Nsurv_SD_sim_prec,i,"Nsurv_SD_sim_prec",1), (logical_eq(i,get_base1(idS_lw,gr,"idS_lw",1)) ? get_base1(Nprec,i,"Nprec",1) : get_base1(Nsurv_SD_sim,(i - 1),"Nsurv_SD_sim",1) ));
                    stan::math::assign(get_base1_lhs(Nsurv_SD_sim,i,"Nsurv_SD_sim",1), binomial_rng(get_base1(Nsurv_SD_sim_prec,i,"Nsurv_SD_sim_prec",1),get_base1(Conditional_Psurv_SD_hat,i,"Conditional_Psurv_SD_hat",1), base_rng__));
                    stan::math::assign(get_base1_lhs(Nsurv_IT_ppc,i,"Nsurv_IT_ppc",1), binomial_rng(get_base1(Nprec,i,"Nprec",1),get_base1(Conditional_Psurv_IT_hat,i,"Conditional_Psurv_IT_hat",1), base_rng__));
                    stan::math::assign(get_base1_lhs(Nsurv_IT_sim_prec,i,"Nsurv_IT_sim_prec",1), (logical_eq(i,get_base1(idS_lw,gr,"idS_lw",1)) ? get_base1(Nprec,i,"Nprec",1) : get_base1(Nsurv_IT_sim,(i - 1),"Nsurv_IT_sim",1) ));
                    stan::math::assign(get_base1_lhs(Nsurv_IT_sim,i,"Nsurv_IT_sim",1), binomial_rng(get_base1(Nsurv_IT_sim_prec,i,"Nsurv_IT_sim_prec",1),get_base1(Conditional_Psurv_IT_hat,i,"Conditional_Psurv_IT_hat",1), base_rng__));
                }
            }
            ...
            for (int k_0__ = 0; k_0__ < n_data_Nsurv; ++k_0__) {
            vars__.push_back(Nsurv_SD_ppc[k_0__]);
            }
            for (int k_0__ = 0; k_0__ < n_data_Nsurv; ++k_0__) {
            vars__.push_back(Nsurv_SD_sim[k_0__]);
            }
            for (int k_0__ = 0; k_0__ < n_data_Nsurv; ++k_0__) {
            vars__.push_back(Nsurv_SD_sim_prec[k_0__]);
            }
            for (int k_0__ = 0; k_0__ < n_data_Nsurv; ++k_0__) {
            vars__.push_back(Nsurv_IT_ppc[k_0__]);
            }
            for (int k_0__ = 0; k_0__ < n_data_Nsurv; ++k_0__) {
            vars__.push_back(Nsurv_IT_sim[k_0__]);
            }
            for (int k_0__ = 0; k_0__ < n_data_Nsurv; ++k_0__) {
            vars__.push_back(Nsurv_IT_sim_prec[k_0__]);
            }
    ...
    static std::string model_name() {
        return "model_ode_TKTD_varCOMBINED";
    }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (int k_0__ = 1; k_0__ <= n_data_Nsurv; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "Psurv_SD_hat" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        for (int k_0__ = 1; k_0__ <= n_data_Nsurv; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "Psurv_IT_hat" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        for (int k_0__ = 1; k_0__ <= n_data_Nsurv; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "Conditional_Psurv_SD_hat" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        for (int k_0__ = 1; k_0__ <= n_data_Nsurv; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "Conditional_Psurv_IT_hat" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        ...
        for (int k_0__ = 1; k_0__ <= n_data_Nsurv; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "Nsurv_SD_ppc" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        for (int k_0__ = 1; k_0__ <= n_data_Nsurv; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "Nsurv_SD_sim" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        for (int k_0__ = 1; k_0__ <= n_data_Nsurv; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "Nsurv_SD_sim_prec" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        for (int k_0__ = 1; k_0__ <= n_data_Nsurv; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "Nsurv_IT_ppc" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        for (int k_0__ = 1; k_0__ <= n_data_Nsurv; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "Nsurv_IT_sim" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        for (int k_0__ = 1; k_0__ <= n_data_Nsurv; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "Nsurv_IT_sim_prec" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
    }
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(260, 260, "end", "model_ode_TKTD_varIT");
    return reader;
}
...
namespace model_ode_TKTD_varIT2_namespace {
...
stan::io::program_reader prog_reader__() {
    stan::io::program_reader reader;
    reader.add_event(0, 0, "start", "model_ode_TKTD_varIT2");
    reader.add_event(257, 257, "end", "model_ode_TKTD_varIT2");
    return reader;
}
...
TKTD_varIT(const T0__& t,
    ...
    try {
        ...
        stan::math::initialize(alpha, std::numeric_limits<double>::quiet_NaN());
        stan::math::fill(alpha,DUMMY_VAR__);
        stan::math::assign(alpha,get_base1(theta,3,"theta",1));
        fun_scalar_t__ beta;
        (void) beta;  // dummy to suppress unused var warning

        stan::math::initialize(beta, std::numeric_limits<double>::quiet_NaN());
        stan::math::fill(beta,DUMMY_VAR__);
        stan::math::assign(beta,get_base1(theta,4,"theta",1));
        validate_non_negative_index("dy_dt", "2", 2);
        vector<fun_scalar_t__> dy_dt(2);
        stan::math::initialize(dy_dt, std::numeric_limits<double>::quiet_NaN());
        stan::math::fill(dy_dt,DUMMY_VAR__);
        ...
        stan::math::assign(get_base1_lhs(dy_dt,1,"dy_dt",1), (kd * (conc_linInterp - get_base1(y,1,"y",1))));
        stan::math::assign(get_base1_lhs(dy_dt,2,"dy_dt",1), ((((-(beta) * pow((get_base1(y,1,"y",1) / alpha),(beta - 1))) / (alpha * pow((1 + pow((get_base1(y,1,"y",1) / alpha),beta)),2))) * (exp((-(hb) * t)) * get_base1(dy_dt,1,"dy_dt",1))) - ((hb * exp((-(hb) * t))) / (1 + pow((get_base1(y,1,"y",1) / alpha),beta)))));
        return stan::math::promote_scalar<fun_return_scalar_t__>(dy_dt);
        }
    } catch (const std::exception& e) {
        stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
...
template <typename T0__, typename T1__, typename T2__, typename T3__, typename T4__, typename T5__, typename T6__>
Eigen::Matrix<typename boost::math::tools::promote_args<T0__, T1__, T2__, T3__, typename boost::math::tools::promote_args<T4__, T5__, T6__>::type>::type, Eigen::Dynamic,Eigen::Dynamic>
solve_TKTD_varIT2(const std::vector<T0__>& y0,
                      const T1__& t0,
                      const std::vector<T2__>& ts,
                      const std::vector<T3__>& theta,
                      const std::vector<T4__>& tconc,
...
struct solve_TKTD_varIT2_functor__ {
    template <typename T0__, typename T1__, typename T2__, typename T3__, typename T4__, typename T5__, typename T6__>
        Eigen::Matrix<typename boost::math::tools::promote_args<T0__, T1__, T2__, T3__, typename boost::math::tools::promote_args<T4__, T5__, T6__>::type>::type, Eigen::Dynamic,Eigen::Dynamic>
    operator()(const std::vector<T0__>& y0,
                      const T1__& t0,
                      ...
                      const std::vector<T5__>& conc,
                      const std::vector<T6__>& odeParam, std::ostream* pstream__) const {
        return solve_TKTD_varIT2(y0, t0, ts, theta, tconc, conc, odeParam, pstream__);
    }
};

class model_ode_TKTD_varIT2 : public prob_grad {
private:
    int n_group;
    int n_data_conc;
    vector<double> conc;
    ...
    vector<double> odeParam;
public:
    model_ode_TKTD_varIT2(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        ctor_body(context__, 0, pstream__);
    }
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_ode_TKTD_varIT2_namespace::model_ode_TKTD_varIT2";
        (void) function__;  // dummy to suppress unused var warning
        size_t pos__;
        (void) pos__;  // dummy to suppress unused var warning
        std::vector<int> vals_i__;
        ...
        try {
            ...
            stan::math::assign(get_base1_lhs(y0,2,"y0",1), 1);
            stan::math::assign(get_base1_lhs(odeParam,1,"odeParam",1), rel_tol);
            stan::math::assign(get_base1_lhs(odeParam,2,"odeParam",1), abs_tol);
            stan::math::assign(get_base1_lhs(odeParam,3,"odeParam",1), max_num_steps);
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::initialize(Psurv_hat, DUMMY_VAR__);
            stan::math::fill(Psurv_hat,DUMMY_VAR__);
            validate_non_negative_index("Conditional_Psurv_hat_noPos", "n_data_Nsurv", n_data_Nsurv);
            Eigen::Matrix<T__,Eigen::Dynamic,1>  Conditional_Psurv_hat_noPos(static_cast<Eigen::VectorXd::Index>(n_data_Nsurv));
            (void) Conditional_Psurv_hat_noPos;  // dummy to suppress unused var warning

            stan::math::initialize(Conditional_Psurv_hat_noPos, DUMMY_VAR__);
            stan::math::fill(Conditional_Psurv_hat_noPos,DUMMY_VAR__);
            validate_non_negative_index("Conditional_Psurv_hat", "n_data_Nsurv", n_data_Nsurv);
            Eigen::Matrix<T__,Eigen::Dynamic,1>  Conditional_Psurv_hat(static_cast<Eigen::VectorXd::Index>(n_data_Nsurv));
            (void) Conditional_Psurv_hat;  // dummy to suppress unused var warning
            ...
            stan::math::assign(get_base1_lhs(param,1,"param",1), pow(10,hb_log10));
            stan::math::assign(get_base1_lhs(param,2,"param",1), pow(10,kd_log10));
            stan::math::assign(get_base1_lhs(param,3,"param",1), pow(10,alpha_log10));
            stan::math::assign(get_base1_lhs(param,4,"param",1), pow(10,beta_log10));
            for (int gr = 1; gr <= n_group; ++gr) {

                stan::model::assign(y_hat, 
                            stan::model::cons_list(stan::model::index_min_max(get_base1(idS_lw,gr,"idS_lw",1), get_base1(idS_up,gr,"idS_up",1)), stan::model::cons_list(stan::model::index_min_max(1, 2), stan::model::nil_index_list())), 
                            solve_TKTD_varIT2(y0,-(1.0000000000000001e-09),stan::model::rvalue(tNsurv, stan::model::cons_list(stan::model::index_min_max(get_base1(idS_lw,gr,"idS_lw",1), get_base1(idS_up,gr,"idS_up",1)), stan::model::nil_index_list()), "tNsurv"),param,stan::model::rvalue(tconc, stan::model::cons_list(stan::model::index_min_max(get_base1(idC_lw,gr,"idC_lw",1), get_base1(idC_up,gr,"idC_up",1)), stan::model::nil_index_list()), "tconc"),stan::model::rvalue(conc, stan::model::cons_list(stan::model::index_min_max(get_base1(idC_lw,gr,"idC_lw",1), get_base1(idC_up,gr,"idC_up",1)), stan::model::nil_index_list()), "conc"),odeParam, pstream__), 
                            "assigning variable y_hat");
                stan::model::assign(Psurv_hat, 
                            stan::model::cons_list(stan::model::index_min_max(get_base1(idS_lw,gr,"idS_lw",1), get_base1(idS_up,gr,"idS_up",1)), stan::model::nil_index_list()), 
                            stan::model::rvalue(y_hat, stan::model::cons_list(stan::model::index_min_max(get_base1(idS_lw,gr,"idS_lw",1), get_base1(idS_up,gr,"idS_up",1)), stan::model::cons_list(stan::model::index_uni(2), stan::model::nil_index_list())), "y_hat"), 
                            "assigning variable Psurv_hat");
                for (int i = get_base1(idS_lw,gr,"idS_lw",1); i <= get_base1(idS_up,gr,"idS_up",1); ++i) {

                    stan::math::assign(get_base1_lhs(Conditional_Psurv_hat_noPos,i,"Conditional_Psurv_hat_noPos",1), (logical_eq(i,get_base1(idS_lw,gr,"idS_lw",1)) ? stan::math::promote_scalar<T__>(get_base1(Psurv_hat,i,"Psurv_hat",1)) : stan::math::promote_scalar<T__>((get_base1(Psurv_hat,i,"Psurv_hat",1) / get_base1(Psurv_hat,(i - 1),"Psurv_hat",1))) ));
                    stan::math::assign(get_base1_lhs(Conditional_Psurv_hat,i,"Conditional_Psurv_hat",1), (logical_lt(get_base1(Conditional_Psurv_hat_noPos,i,"Conditional_Psurv_hat_noPos",1),0) ? stan::math::promote_scalar<T__>(0) : stan::math::promote_scalar<T__>(get_base1(Conditional_Psurv_hat_noPos,i,"Conditional_Psurv_hat_noPos",1)) ));
                }
            }
            ...
            for (int i0__ = 0; i0__ < n_data_Nsurv; ++i0__) {
                if (stan::math::is_uninitialized(Conditional_Psurv_hat_noPos(i0__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: Conditional_Psurv_hat_noPos" << '[' << i0__ << ']';
                    throw std::runtime_error(msg__.str());
                }
            }
            for (int i0__ = 0; i0__ < n_data_Nsurv; ++i0__) {
            ...
            for (int gr = 1; gr <= n_group; ++gr) {
                ...
                lp_accum__.add(binomial_log<propto__>(stan::model::rvalue(Nsurv, stan::model::cons_list(stan::model::index_min_max(get_base1(idS_lw,gr,"idS_lw",1), get_base1(idS_up,gr,"idS_up",1)), stan::model::nil_index_list()), "Nsurv"), stan::model::rvalue(Nprec, stan::model::cons_list(stan::model::index_min_max(get_base1(idS_lw,gr,"idS_lw",1), get_base1(idS_up,gr,"idS_up",1)), stan::model::nil_index_list()), "Nprec"), stan::model::rvalue(Conditional_Psurv_hat, stan::model::cons_list(stan::model::index_min_max(get_base1(idS_lw,gr,"idS_lw",1), get_base1(idS_up,gr,"idS_up",1)), stan::model::nil_index_list()), "Conditional_Psurv_hat")));
            }
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("y_hat");
        names__.push_back("Psurv_hat");
        names__.push_back("Conditional_Psurv_hat_noPos");
        names__.push_back("Conditional_Psurv_hat");
        names__.push_back("Nsurv_ppc");
        names__.push_back("Nsurv_sim");
        names__.push_back("Nsurv_sim_prec");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<double> in__(params_r__,params_i__);
        static const char* function__ = "model_ode_TKTD_varIT2_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        double hb_log10 = in__.scalar_constrain();
        double kd_log10 = in__.scalar_constrain();
        ...
        try {
            ...
            stan::math::fill(Psurv_hat,DUMMY_VAR__);
            validate_non_negative_index("Conditional_Psurv_hat_noPos", "n_data_Nsurv", n_data_Nsurv);
            vector_d Conditional_Psurv_hat_noPos(static_cast<Eigen::VectorXd::Index>(n_data_Nsurv));
            (void) Conditional_Psurv_hat_noPos;  // dummy to suppress unused var warning

            stan::math::initialize(Conditional_Psurv_hat_noPos, std::numeric_limits<double>::quiet_NaN());
            stan::math::fill(Conditional_Psurv_hat_noPos,DUMMY_VAR__);
            validate_non_negative_index("Conditional_Psurv_hat", "n_data_Nsurv", n_data_Nsurv);
            vector_d Conditional_Psurv_hat(static_cast<Eigen::VectorXd::Index>(n_data_Nsurv));
            (void) Conditional_Psurv_hat;  // dummy to suppress unused var warning
            ...
            for (int gr = 1; gr <= n_group; ++gr) {
                ...
                for (int i = get_base1(idS_lw,gr,"idS_lw",1); i <= get_base1(idS_up,gr,"idS_up",1); ++i) {
                    ...
                    stan::math::assign(get_base1_lhs(Conditional_Psurv_hat_noPos,i,"Conditional_Psurv_hat_noPos",1), (logical_eq(i,get_base1(idS_lw,gr,"idS_lw",1)) ? stan::math::promote_scalar<double>(get_base1(Psurv_hat,i,"Psurv_hat",1)) : stan::math::promote_scalar<double>((get_base1(Psurv_hat,i,"Psurv_hat",1) / get_base1(Psurv_hat,(i - 1),"Psurv_hat",1))) ));
                    stan::math::assign(get_base1_lhs(Conditional_Psurv_hat,i,"Conditional_Psurv_hat",1), (logical_lt(get_base1(Conditional_Psurv_hat_noPos,i,"Conditional_Psurv_hat_noPos",1),0) ? stan::math::promote_scalar<double>(0) : stan::math::promote_scalar<double>(get_base1(Conditional_Psurv_hat_noPos,i,"Conditional_Psurv_hat_noPos",1)) ));
                }
            }
            ...
            for (int k_0__ = 0; k_0__ < n_data_Nsurv; ++k_0__) {
            vars__.push_back(Conditional_Psurv_hat_noPos[k_0__]);
            }
            for (int k_0__ = 0; k_0__ < n_data_Nsurv; ++k_0__) {
            vars__.push_back(Conditional_Psurv_hat[k_0__]);
            }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (int k_0__ = 1; k_0__ <= n_data_Nsurv; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "Conditional_Psurv_hat_noPos" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        for (int k_0__ = 1; k_0__ <= n_data_Nsurv; ++k_0__) {
            param_name_stream__.str(std::string());
...
namespace model_ode_TKTD_varIT2_bdf_namespace {
...
stan::io::program_reader prog_reader__() {
    stan::io::program_reader reader;
    reader.add_event(0, 0, "start", "model_ode_TKTD_varIT2_bdf");
    reader.add_event(258, 258, "end", "model_ode_TKTD_varIT2_bdf");
    return reader;
}
...
class model_ode_TKTD_varIT2_bdf : public prob_grad {
private:
    int n_group;
    int n_data_conc;
    vector<double> conc;
    ...
    vector<double> odeParam;
public:
    model_ode_TKTD_varIT2_bdf(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        ctor_body(context__, 0, pstream__);
    }
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_ode_TKTD_varIT2_bdf_namespace::model_ode_TKTD_varIT2_bdf";
        (void) function__;  // dummy to suppress unused var warning
        size_t pos__;
        (void) pos__;  // dummy to suppress unused var warning
        std::vector<int> vals_i__;
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<double> in__(params_r__,params_i__);
        static const char* function__ = "model_ode_TKTD_varIT2_bdf_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        double hb_log10 = in__.scalar_constrain();
        double kd_log10 = in__.scalar_constrain();
    ...
    static std::string model_name() {
        return "model_ode_TKTD_varIT2_bdf";
    }
...
namespace model_ode_TKTD_varPROPER_loglogistic_namespace {
...
stan::io::program_reader prog_reader__() {
    stan::io::program_reader reader;
    reader.add_event(0, 0, "start", "model_ode_TKTD_varPROPER_loglogistic");
    reader.add_event(251, 251, "end", "model_ode_TKTD_varPROPER_loglogistic");
    return reader;
}
...
solve_TKTD_varPROPER(const std::vector<T0__>& y0,
    ...
    try {
        ...
        stan::math::assign(get_base1_lhs(x_i,1,"x_i",1), size(tconc));
        return stan::math::promote_scalar<fun_return_scalar_t__>(to_matrix(integrate_ode_rk45(TKTD_varPROPER_functor__(), y0, t0, ts, theta, to_array_1d(append_row(to_vector(tconc),to_vector(conc))), x_i, pstream__, 9.9999999999999995e-08, 0.0001, 1000.0)));
        }
    } catch (const std::exception& e) {
        stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
        // Next line prevents compiler griping about no return
...
struct solve_TKTD_varPROPER_functor__ {
    ...
    operator()(const std::vector<T0__>& y0,
                         ...
                         const std::vector<T4__>& tconc,
                         const std::vector<T5__>& conc, std::ostream* pstream__) const {
        return solve_TKTD_varPROPER(y0, t0, ts, theta, tconc, conc, pstream__);
    }
};

class model_ode_TKTD_varPROPER_loglogistic : public prob_grad {
private:
    int n_group;
    int n_data_conc;
    vector<double> conc;
    ...
    vector<double> y0;
public:
    model_ode_TKTD_varPROPER_loglogistic(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        ctor_body(context__, 0, pstream__);
    }
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_ode_TKTD_varPROPER_loglogistic_namespace::model_ode_TKTD_varPROPER_loglogistic";
        (void) function__;  // dummy to suppress unused var warning
        size_t pos__;
        (void) pos__;  // dummy to suppress unused var warning
        std::vector<int> vals_i__;
    ...
    ~model_ode_TKTD_varPROPER_loglogistic() { }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            for (int gr = 1; gr <= n_group; ++gr) {
                ...
                stan::model::assign(y_hat, 
                            stan::model::cons_list(stan::model::index_min_max(get_base1(idS_lw,gr,"idS_lw",1), get_base1(idS_up,gr,"idS_up",1)), stan::model::cons_list(stan::model::index_min_max(1, 2), stan::model::nil_index_list())), 
                            solve_TKTD_varPROPER(y0,-(1.0000000000000001e-09),stan::model::rvalue(tNsurv, stan::model::cons_list(stan::model::index_min_max(get_base1(idS_lw,gr,"idS_lw",1), get_base1(idS_up,gr,"idS_up",1)), stan::model::nil_index_list()), "tNsurv"),param,stan::model::rvalue(tconc, stan::model::cons_list(stan::model::index_min_max(get_base1(idC_lw,gr,"idC_lw",1), get_base1(idC_up,gr,"idC_up",1)), stan::model::nil_index_list()), "tconc"),stan::model::rvalue(conc, stan::model::cons_list(stan::model::index_min_max(get_base1(idC_lw,gr,"idC_lw",1), get_base1(idC_up,gr,"idC_up",1)), stan::model::nil_index_list()), "conc"), pstream__), 
                            "assigning variable y_hat");
                stan::model::assign(Psurv_hat, 
                            stan::model::cons_list(stan::model::index_min_max(get_base1(idS_lw,gr,"idS_lw",1), get_base1(idS_up,gr,"idS_up",1)), stan::model::nil_index_list()), 
                            exp(minus(stan::model::rvalue(y_hat, stan::model::cons_list(stan::model::index_min_max(get_base1(idS_lw,gr,"idS_lw",1), get_base1(idS_up,gr,"idS_up",1)), stan::model::cons_list(stan::model::index_uni(2), stan::model::nil_index_list())), "y_hat"))), 
            ...
            lp_accum__.add(normal_log<propto__>(alpha_log10, alpha_meanlog10, alpha_sdlog10));
            lp_accum__.add(uniform_log<propto__>(beta_log10, beta_minlog10, beta_maxlog10));
            lp_accum__.add(loglogistic_lpdf<propto__>(z, pow(10,alpha_log10), pow(10,beta_log10), pstream__));
            for (int gr = 1; gr <= n_group; ++gr) {
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<double> in__(params_r__,params_i__);
        static const char* function__ = "model_ode_TKTD_varPROPER_loglogistic_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        double kk_log10 = in__.scalar_constrain();
        double kd_log10 = in__.scalar_constrain();
    ...
    static std::string model_name() {
        return "model_ode_TKTD_varPROPER_loglogistic";
    }
...
namespace model_ode_TKTD_varPROPER_lognormal_namespace {
...
stan::io::program_reader prog_reader__() {
    stan::io::program_reader reader;
    reader.add_event(0, 0, "start", "model_ode_TKTD_varPROPER_lognormal");
    reader.add_event(242, 242, "end", "model_ode_TKTD_varPROPER_lognormal");
    return reader;
}
...
class model_ode_TKTD_varPROPER_lognormal : public prob_grad {
private:
    int n_group;
    int n_data_conc;
    vector<double> conc;
    ...
    vector<double> y0;
public:
    model_ode_TKTD_varPROPER_lognormal(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        ctor_body(context__, 0, pstream__);
    }
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_ode_TKTD_varPROPER_lognormal_namespace::model_ode_TKTD_varPROPER_lognormal";
        (void) function__;  // dummy to suppress unused var warning
        size_t pos__;
        (void) pos__;  // dummy to suppress unused var warning
        std::vector<int> vals_i__;
    ...
    ~model_ode_TKTD_varPROPER_lognormal() { }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(normal_log<propto__>(alpha_log10, alpha_meanlog10, alpha_sdlog10));
            lp_accum__.add(uniform_log<propto__>(beta_log10, beta_minlog10, beta_maxlog10));
            lp_accum__.add(lognormal_log<propto__>(z, pow(10,alpha_log10), pow(10,beta_log10)));
            for (int gr = 1; gr <= n_group; ++gr) {
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<double> in__(params_r__,params_i__);
        static const char* function__ = "model_ode_TKTD_varPROPER_lognormal_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        double kk_log10 = in__.scalar_constrain();
        double kd_log10 = in__.scalar_constrain();
    ...
    static std::string model_name() {
        return "model_ode_TKTD_varPROPER_lognormal";
    }
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(272, 272, "end", "model_ode_TKTD_varSD");
    return reader;
}
